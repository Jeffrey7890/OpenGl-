...
// camera
Camera camera(glm::vec3(-1.3f, 0.0f, 5.0f),  glm::vec3(0.0f, 1.0f, 0.0f), -70.0f );
...
int main()
{
	...
	Shader lightingShader("Lighting/shaders/vertex.vs", "Lighting/shaders/fragment.fs");
	Shader lightCubeShader("Lighting/shaders/light.vs", "Lighting/shaders/light.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightPos = glm::vec3(1.0f, 0.5f, 3.0f);
		//std::cout << camera.Position.x << " " << camera.Position.y << " " << camera.Position.z << std::endl;
		processInput(window) ;
		...
		glm::vec3 diffuseColor = glm::vec3(1.0f)* glm::vec3(0.5f);
		glm::vec3 ambientColor = glm::vec3(1.0f) * glm::vec3(0.2f);

		lightingShader.setVec3("light.ambient", glm::vec3(1.0f));
		lightingShader.setVec3("light.diffuse", glm::vec3(1.0f)); // darkened
